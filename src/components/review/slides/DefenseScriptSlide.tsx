...
const DEFENSE_SLIDES: DefenseSlide[] = [
  {
    ...
    spokenScript: 'Good day, distinguished panel members and examiners. Today, we are proud to present the Student Results Management System for the Federal University of Agriculture, Zuru. Academic integrity is the bedrock of any tertiary institution. This project was developed to replace vulnerable paper sheets and manual spreadsheets with an automated, role-governed portal built strictly to NUC 5.0 CGPA benchmarks.',
    likelyQuestion: 'Why build a custom SRMS rather than using a generic spreadsheet or standard LMS?',
    suggestedAnswer: 'Generic spreadsheets lack role separation, custody locking, and immutable audit trails. In our system, a lecturer cannot alter scores after submitting to the Chief Examiner, and every override requires a permanent logged justification.',
  },
  {
    slideNumber: 2,
    ...
    duration: '2.0 Mins',
    mainPoints: [
      'Role Separation: Student, Course Lecturer, Chief Examiner/HOD, Senate Administrator.',
    ...
    spokenScript: 'The architecture enforces strict separation of duties. Course lecturers can only access courses assigned by their department. Once they submit Continuous Assessment and Exam scores, their sheet is locked to prevent tampering. The Chief Examiner audits the broadsheet and retains the sole authority to approve and publish live to student portals.',
  ...
  },
  {
    ...
    spokenScript: 'Academic transparency requires that no score modification remains anonymous. Our Moderation Audit Trail permanently logs any override executed by an examiner. Furthermore, students are empowered with a formal Dispute Portal where they can file claims that appear directly in the Chief Examiner investigation queue.',
    likelyQuestion: 'What happens if a lecturer makes a genuine mistake in a batch CSV upload?',
  ...
  },
  {
    ...
    spokenScript: 'Finally, the system bridges digital records with official institutional documents. Examination offices can generate print-ready horizontal Senate broadsheets with a single click, while students can generate vector PDF result slips bearing cryptographic tracking codes. Thank you for your attention, and we welcome your questions.',
      ...
      <div className="bg-gradient-to-r from-amber-950 via-[#064e3b] to-slate-900 text-white p-6 sm:p-8 rounded-2xl shadow-md border border-amber-800/40">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
          <span className="px-3 py-1 rounded-full bg-amber-500/20 text-amber-200 text-xs font-bold tracking-wider uppercase border border-amber-500/30">
            Section 06 • Defense Presentation
          </span>
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white mb-2">
          Interactive Defense Presentation & Speaker Script
        </h2>
        <p className="text-sm sm:text-base text-amber-100 max-w-3xl leading-relaxed">
          Slide-by-slide rehearsal walkthrough tailored for academic project defenses, seminar presentations, and external examiner reviews.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-6">
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
            Slide Display Content (What the Panel Sees)
          </h4>
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-bold uppercase tracking-wider text-amber-700 dark:text-amber-400 flex items-center gap-1.5">
            <Mic className="w-4 h-4" /> Spoken Presentation Script (What You Say to the Panel)
          </h4>
          <div className="p-5 rounded-xl bg-amber-50/50 dark:bg-amber-950/20 border border-amber-200/80 dark:border-amber-900/40 text-xs sm:text-sm text-slate-800 dark:text-slate-200 leading-relaxed font-sans italic">
            "{slide.spokenScript}"
          </div>
        </div>
        ...
        <div className="p-5 rounded-xl bg-purple-50/50 dark:bg-purple-950/20 border border-purple-200/80 dark:border-purple-900/40 space-y-2">
          <div className="flex items-center gap-2 text-xs font-bold text-purple-800 dark:text-purple-300 uppercase tracking-wider">
            <HelpCircle className="w-4 h-4 text-purple-600" /> Anticipated Panel Question
          </div>
