      ...
      <CardHeader className="border-b border-slate-100 dark:border-slate-800 p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <CardDescription className="text-xs text-slate-500 dark:text-slate-400">
            Create, audit, modify, and test role-based accounts across the institution
          </CardDescription>
        </div>
        <Button
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50 dark:bg-slate-800/50">
                ...
                <TableHead className="text-right pr-6">Account Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredUsers.map((u) => (
                <TableRow key={u.id} className="hover:bg-slate-50/70 dark:hover:bg-slate-800/40">
                  ...
                  <TableCell className="text-right pr-6 space-x-1.5">
                    ...
                    >
                      <LogIn className="w-3 h-3" /> Sign In As
                    </Button>
                    <Button
                      variant="ghost"
                      size="icon"
