...
export const REVIEW_SECTIONS: ReviewSection[] = [
  ...
  },
  {
    id: 'terms',
    number: '03',
    title: 'Definition of Terms & Technologies',
    shortTitle: 'Definition of Terms',
    subtitle: 'Official academic glossary and technical specifications decoded',
    iconName: 'FileText',
    summary: 'A clear definition and academic glossary explaining the key tools, frameworks, and institutional grading scales powering this project.',
    estimatedMinutes: 3,
  },
  {
    id: 'roles',
  ...
  },
  {
    id: 'defense',
    number: '08',
    title: 'Project Defense Presentation Outline',
    shortTitle: 'Defense Outline',
    subtitle: 'Slide-by-slide presentation outline and academic notes ready for defense',
    iconName: 'Presentation',
    summary: 'Structured academic defense slides complete with timing, key takeaways, and first-person speaking notes for presentation.',
    estimatedMinutes: 6,
  },
  {
    id: 'roadmap',
